...
public class RepositoryUtils {
    ...
    public UserResponse getFullUserResponse(UserResponse userResponse) {
        return UserResponse
                ...
                .answer(getFullAnswer(answerRepository.findAnswerById(userResponse.getAnswer().getId())))
                .question(getFullQuestion(questionRepository.findQuestionById(userResponse.getQuestion().getId())))
